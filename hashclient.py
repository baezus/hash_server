...
arguments=.add_argument('-port', type=int, action='store', default='2345', help='[Optional]: Which port the client accesses. Default: 2345.')
...
arguments=add.argument('files', action='store', nargs=argparse.REMAINDER, help='Which files the client wants to hash.')
